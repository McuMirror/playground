...
JNIEXPORT jint JNICALL Java_aes_imhei_AESImhei_CashlessReadData
  (JNIEnv * env, jclass obj, jint JavaInt, jobject JavaObject)
    ...
    // Get the information
     CashlessControlBlock MySnapshot ;
     jboolean RetVal = (CashlessReadData(JavaInt, &MySnapshot) != 0) ;

     if (RetVal)
        {
        env->SetIntField(JavaObject,    env->GetFieldID(Javaclass, "CashlessType" , "I"), MySnapshot.CashlessType ) ;
        env->SetObjectField(JavaObject, env->GetFieldID(Javaclass, "Description", "Ljava/lang/String;"),
                                                                        env->NewStringUTF(MySnapshot.Description));
        env->SetIntField(JavaObject,    env->GetFieldID(Javaclass, "SerialNumber" , "I"), MySnapshot.SerialNumber         ) ;
        env->SetIntField(JavaObject,    env->GetFieldID(Javaclass, "TotalAcquisitions", "I"), MySnapshot.TotalAcquisitions        ) ;
        env->SetIntField(JavaObject,    env->GetFieldID(Javaclass, "TotalCredit"  , "I"), MySnapshot.TotalCredit    ) ;

        env->SetIntField(JavaObject,    env->GetFieldID(Javaclass, "CurrentState" , "I"), MySnapshot.CurrentState    ) ;
        env->SetIntField(JavaObject,    env->GetFieldID(Javaclass, "StateDetails" , "I"), MySnapshot.StateDetails    ) ;
        env->SetIntField(JavaObject,    env->GetFieldID(Javaclass, "CreditValue"  , "I"), MySnapshot.CreditValue    ) ;
        env->SetObjectField(JavaObject, env->GetFieldID(Javaclass, "ReferenceData", "Ljava/lang/String;"),
                                                                        env->NewStringUTF(MySnapshot.ReferenceData));
        }
    return RetVal ;
    }
...
JNIEXPORT void JNICALL Java_aes_imhei_AESImhei_CashlessRequestCredit
  (JNIEnv * env, jclass obj, jint JavaInt, jint JavaInt2)
    {
    CashlessRequestCredit(JavaInt, JavaInt2) ;
    }
